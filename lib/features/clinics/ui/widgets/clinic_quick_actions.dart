...
/// Contact actions for a clinic — call, WhatsApp, email, map. Mirrors the
/// doctor detail screen's quick actions exactly, so the two feel like one
/// product; the clinic's website gets its own info tile instead of a fifth
/// slot here.
class ClinicQuickActions extends StatelessWidget {
  const ClinicQuickActions({super.key, required this.clinic});
  ...
  Widget build(BuildContext context) {
    final phone = clinic.phoneNumber?.trim() ?? '';
    final email = clinic.email?.trim() ?? '';
