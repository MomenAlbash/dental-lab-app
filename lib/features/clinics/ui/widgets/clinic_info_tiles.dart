...
/// Clinic attributes as a tile mosaic — mirrors the doctor/patient detail
/// screens' treatment so the three features read as one design language.
class ClinicInfoTiles extends StatelessWidget {
  const ClinicInfoTiles({super.key, required this.clinic});
      ...
      builder: (context, constraints) {
        ...
        return Column(
          ...
          children: [
            ...
            if (clinic.address?.trim().isNotEmpty ?? false) ...[
