...
/// The clinics list: search field plus the (locally filtered) list of
          ...
          children: [
            ...
            Expanded(
              child: clinics.isEmpty
                  ...
                  : AdaptiveCollection<ClinicModel>(
                      items: clinics,
                      scrollController: scrollController,
                      onRefresh: () =>
                          context.read<ClinicsCubit>().getClinics(),
                      itemBuilder: (context, clinic, _) => ClinicListItemWidget(
                        name: clinic.name,
                        ...
                        // own edit action, so a clinic can come back
                        // changed. Without this the list would keep
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isSearching ? 'لا توجد نتائج' : 'لا يوجد عيادات بعد',
                ...
                Text(
                  isSearching
                      ...
                      : 'أضف أول عيادة بالضغط على زر الإضافة',
                  textAlign: TextAlign.center,
